export const GAME_LANG = {
  zh: {
    ...
    uiStyleColorful: "彩色",
    uiStyleDuotone: "双色",
    uiStyleCopy: "请选择 LineFit 的方块样式。此设置只改变画面，不影响棋盘、成绩或挑战公平性。以后可在 Setting → UI Style 中修改。",
    uiStyleConfirm: "确认",
  ...
  en: {
    ...
    energy: "Energy",
    uiStyleTitle: "UI Style",
    uiStyleColorful: "Colorful",
    uiStyleDuotone: "Duotone",
    uiStyleCopy: "Choose a block style for LineFit. This setting changes visuals only and does not affect the board, score, or challenge fairness. You can change it later in Setting → UI Style.",
    uiStyleConfirm: "Confirm",
